...
<body>
    ...
    <div class="container"><h1 class="page-header"></h1>
   <center>   <div class="logo"> <!-- Un contenedor con la clase "logo" -->
            <img src="img/555.jpg">
<h1 class="page-header"></h1>
<div class="well well-sm text right">
    <!--MUESTRA EL NOMBRE DEL USUARIO GUARDADO EN LA VARIABLE SESSION-->
<center><h1><?php echo "BIENVENID@  "?></h1></center>
<!--SE CREA BOTON QUE DIRIGE AL CONTROLADOR SALIR-->
<br>
<br>
<a class="btn btn-success" href="Usuarios.php">GESTION USUARIOS</a></center>
 <br>
 <br>    
<center><a class="btn btn-success" href="../Controlador/Salir.php">Salir</a></center>
</div>
