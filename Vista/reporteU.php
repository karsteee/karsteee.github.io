...
function Header()
{
    ...
    $this->Image('img/usuarios.jpg',10,8,-300);
    // Arial bold 15
...
$pdf->Cell(65,10,utf8_decode('Correo'),1,1,'C',0);
...
if($Usuario!=null){
    foreach($Usuario as $r){
        ...
        $pdf->Cell(20);
        $pdf->Cell(8,10,utf8_decode($r['idUsuario']),1,0,'C',0);
        $pdf->Cell(40,10,utf8_decode($r['nombreUsuario']),1,0,'C',0);
        $pdf->Cell(40,10,utf8_decode($r['apellidoUsuario']),1,0,'C',0);
        $pdf->Cell(65,10,utf8_decode($r['correoUsuario']),1,1,'C',0);
