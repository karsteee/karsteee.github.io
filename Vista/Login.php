...
<head>
    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Roboto:wght@100<input type="email placeholder="sophie@example.com" >
    <link rel="stylesheet" href="css/fontawesome.min.css">

    <!-- Load map styles -->
    <link rel="stylesheet" href="https://unpkg.com/leaflet@1.7.1/dist/leaflet.css" integrity="sha512-xodZBNTC5n17Xt2atTPuE1HxjVMSvLVW9ocqUKLsCC5CXdbqCmblAshOMAS6/keqq/sMZMZ19scR4PsZChSR7A==" crossorigin="" />
</head>
<body> <nav class="navbar navbar-expand-lg bg-dark navbar-light d-none d-lg-block" id="templatemo_nav_top">
   ...
   <div class="container">
        ...
        <form method="POST" action="../Controlador/Login.php" id="frm-login" enctype="multipart/form-data">
            <div class="form-group">
                <label>Usuario</label>
                <input type="text" name="correoUsuario" class="form-control" placeholder="Usuario" required="true" />
            </div>
            <div class="form-group">
                <label>Contraseña</label>
                <input type="password" name="passwordUsuario" class="form-control" placeholder="Contraseña" required="true" />
            </div>
            <br>
