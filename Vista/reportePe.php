...
function Header()
{
    ...
    $this->Cell(60);
    // Titulo
    $this->Cell(90,10,'REPORTE DE PEDIDOS',1,0,'C');
    // Salto de linea
    $this->Ln(20);
}
...
$pdf->Cell(60,10,utf8_decode('Fecha'),1,0,'C',0);
$pdf->Cell(40,10,utf8_decode('Hora'),1,0,'C',0);
...
if($Pedido!=null){
    foreach($Pedido as $r){
        ...
        $pdf->Cell(20);
        $pdf->Cell(8,10,utf8_decode($r['idPedido']),1,0,'C',0);
        $pdf->Cell(60,10,utf8_decode($r['fechaPedido']),1,0,'C',0);
        $pdf->Cell(40,10,utf8_decode($r['horaPedido']),1,0,'C',0);
        $pdf->Cell(40,10,utf8_decode($r['totalPedido']),1,1,'C',0);
